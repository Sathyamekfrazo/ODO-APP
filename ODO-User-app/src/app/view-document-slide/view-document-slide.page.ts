...
@Component({
  selector: 'app-view-document-slide',
  templateUrl: './view-document-slide.page.html',
  styleUrls: ['./view-document-slide.page.scss'],
})
export class ViewDocumentSlidePage implements OnInit {
  values = [];
  ...
  getAllVehicleData(){
    this.service.getDocument().subscribe(
      (resp: any) => {
        ...
        this.fulldata=resp.result.other_document_data;
