...
export class ApiService {
  ...
  getVehileListData(): Observable<any> {
    ...
    // return this.httpClient.get<any>(this.ApiUrl + 'userapp/vehicle');
    return this.httpClient.get<any>(this.ApiUrl + 'userapp/document-details?user_id='+userId);
  }
  ...
  getDocument(): Observable<any> {
    let userId=localStorage.getItem('userId');
    return this.httpClient.get<any>(this.ApiUrl + 'userapp/document_data?user_id='+userId);
  }
